                ...
                <table class="min-w-full border border-gray-300">
                    ...
                    <tbody>
                        <tr class="bg-white dark:bg-gray-800 dark:border-gray-700" v-for="todo in todos" :key="todo.id">
                            ...
                            <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ todo?.project?.name }}</td>
                            <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ `${todo?.tasks.data.filter(t => t.is_completed == 1).length} / ${todo?.tasks.length}` }} </td>
